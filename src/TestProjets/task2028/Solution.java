...
public class Solution {
    public static void main(String[] args) {
       ...
       /* for (int i = 1; i < 16 ; i++) { // для проверки всех элементов и соответствия их родителям

            System.out.println("For " + i + " parent is " + ((CustomTree) list).getParent(String.valueOf(i)));
        }
